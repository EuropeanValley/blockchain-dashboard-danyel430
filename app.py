...
from modules import m1_pow_monitor, m2_block_header, m3_difficulty_history, m4_ai_component, m5_merkle_verifier, m6_security_score, m7_ai_predictor
...
with st.sidebar:
    ...
    st.markdown("-  M7 · AI Difficulty Predictor")
    st.divider()
